...
from mcp_web_context.scraper import NoDriverScraper


async def fetch_html_with_scraper(url: str) -> str:
    """Fetch HTML from URL using the NoDriverScraper with caching to test_data"""
    ...
    print(f"Fetching HTML from {url} using NoDriverScraper")
